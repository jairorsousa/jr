    ...
    <nav class="p-3 space-y-1">
        @php
            $menuItems = [
                ...
                ['route' => 'bets.dashboard', 'icon' => 'sports_soccer', 'label' => 'Bets'],
                ['route' => 'bets.houses', 'icon' => 'storefront', 'label' => 'Casas Bet'],
                ['route' => 'bets.users', 'icon' => 'groups', 'label' => 'Usuarios Bet'],
                ['route' => 'bets.accounts', 'icon' => 'account_balance_wallet', 'label' => 'Contas Bet'],
                ['route' => 'bets.transactions', 'icon' => 'receipt_long', 'label' => 'Transacoes Bet'],
                ['route' => 'crypto.dashboard', 'icon' => 'currency_bitcoin', 'label' => 'Cripto'],
                ['route' => 'crypto.institutions', 'icon' => 'currency_exchange', 'label' => 'Instituicoes Cripto'],
                ['route' => 'crypto.accounts', 'icon' => 'account_balance_wallet', 'label' => 'Contas Cripto'],
                ['route' => 'crypto.transactions', 'icon' => 'swap_vert', 'label' => 'Transacoes Cripto'],
